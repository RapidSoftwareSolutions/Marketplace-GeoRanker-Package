...
$app->post('/api/GeoRanker/getSingleUser', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['email', 'session', 'userId']);
    ...
    $url = $settings['apiUrl'] . "/user/" . $postData['args']['userId'] . ".json?";
